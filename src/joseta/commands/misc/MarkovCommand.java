...
public class MarkovCommand extends Command {
    ...
    public MarkovCommand() {
        super("markov",
            "Generates a message using the server sent messages.",
    ...
    protected void runImpl(SlashCommandInteractionEvent event) {
        ...
        Seq<MarkovMessagesDatabase.MessageEntry> entries = MarkovMessagesDatabase.getMessageEntries(event.getGuild().getIdLong());
